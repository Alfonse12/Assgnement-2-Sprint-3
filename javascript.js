...
Explore
 @Alfonse12 Sign out
0
0 0 Alfonse12/Alfonse12.github.io
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights  Settings
Alfonse12.github.io/javascript.js
5cff7e1  3 days ago
@Alfonse12 Alfonse12 Testing
     
337 lines (304 sloc)  14.8 KB
...
// The function to desplay any color that the player want to set as background of the screen.
function personalize(){
	var colour = document.getElementById("color").value;
	var balise = document.getElementsByTagName("body");
	balise[0].style["background"] = colour;
...
Blog
About
Press h to open a hovercard with more details.ffs();
	store();timing();
}
//Relies to the code behind the Restart button up in the left corner on the App Page. Helps to pause or to reload the game
function menu(action){
